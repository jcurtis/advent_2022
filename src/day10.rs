...
#[aoc_generator(day10)]
fn generator(input: &str) -> Vec<Ins> {
    let mut x = 1;
    input
        .trim()
        .lines()
        .flat_map(|ins| {
            ...
            match ins[0] {
                ...
                "addx" => {
                    ...
                    x += val;
                    vec![(Cmd::PreAdd, pre_x), (Cmd::Addx, pre_x)]
                }
                _ => unreachable!(),
            }
        })
...
fn map_sprite(i: usize, ins: &Ins) -> char {
    let cycle = i as i32;
    let x = ins.1;
